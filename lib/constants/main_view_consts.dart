...
class MainViewConsts {
  double sliderHeight = 143;
  double sliderRadius = 12;
  double sliderAgeLimitHeight = 20;
  double sliderAgeLimitWidth = 25;
  double sliderAgeRadius = 2;
  double sliderNameRadius = 6;
  double sliderNamePadding = 5;
  double sliderButtonMinWith = 0;
